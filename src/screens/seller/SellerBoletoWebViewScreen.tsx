// src/screens/seller/SellerBoletoWebViewScreen.tsx
...
export function SellerBoletoWebViewScreen({ route, navigation }: any) {
  ...
  const goBackSafe = () => {
    navigation.replace(SELLER_SCREENS.PaymentMethods, { orderId });
  };
  ...
  if (!finalUrl) {
    return (
      <View style={s.center}>
        ...
        <Pressable onPress={goBackSafe} style={s.btn}>
  ...
  return (
    <View style={s.root}>
      ...
      <View style={s.header}>
        <Pressable hitSlop={12} onPress={goBackSafe} style={s.headerBtn}>
      ...
      {failed ? (
        <View style={s.center}>
          ...
          <View style={{ flexDirection: "row", gap: 10, marginTop: 12 }}>
            ...
            <Pressable onPress={goBackSafe} style={[s.btn, { opacity: 0.9 }]}>
              <Text style={s.btnText}>Voltar</Text>
            </Pressable>
          </View>
        </View>

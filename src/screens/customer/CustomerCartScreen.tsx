      ...
      setConfirm({
        ...
        actions: [
          ...
          },
          {
            ...
            style: "destructive",
            onPress: () => nav.navigate(CUSTOMER_SCREENS.ShippingMethod, { items: itemsPayload, couponCode: appliedCoupon || undefined }),
          },
        ],
      });
      return;
  ...
  return (
    <>
      <SharedOwnerCustomerCartScreen
        ...
        onOpenProduct={(productId) => nav.navigate(CUSTOMER_SCREENS.ProductDetails, { productId })}
        onInc={(productId) => {
          if (mutating) return;

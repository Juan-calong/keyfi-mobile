...
import { handleNotificationClick } from "../../core/notifications/notification-actions";
import {
...
export function CustomerNotificationsScreen() {
  ...
  const notificationsQ = useQuery({ queryKey: ["customer-notifications"], queryFn: listMyNotifications, retry: false });
  const unreadQ = useQuery({ queryKey: ["customer-notifications-unread-count"], queryFn: getUnreadNotificationsCount, retry: false });
                ...
                return (
                  <Pressable
                    onPress={async () => {
                      ...
                      handleNotificationClick(item, (screen, params) => nav.navigate(screen, params));
                    }}
                  >

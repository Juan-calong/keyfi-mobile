...
quantityOfferText: {
  ...
  reviewsSummaryRow: { flexDirection: "row", gap: 12, alignItems: "center" },
  reviewsAverageBlock: { minWidth: 78 },
  reviewsAverageScore: { color: "#111111", fontSize: 32, fontWeight: "900" },
  reviewsAverageStar: { color: "#C28A20", fontSize: 22, fontWeight: "900", marginTop: -6 },
